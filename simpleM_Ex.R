...
#============================================================================
# fix length, simpleM
fn_In <- "data/geno_mat_simpleM_allchr.txt"				# <---- change path here!!!
mySNP_nonmissing <- as.matrix(fread(fn_In))[, 1:188] # take only HD individuals because unrelated and good genotypes		
