...
saveRDS(mod_inla, file = "output/AS_mod_INLA_398k_w_mumid.rds")
...
all_inla_mods <- readRDS(file = "output/inla_survival_models_diff_ages_froh_all_398k.rds")
...
p_froh_across_life
ggsave("figs/sup_froh_across_life.jpg", width = 4, height = 2.5)
